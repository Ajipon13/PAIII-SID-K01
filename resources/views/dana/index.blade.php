    ...
    <section class="content">
        ...
        @if(session('success'))
          ...
          <div class="card">    
            <div class="card bg-yellow shadow" style="border-radius:20px;">
              <h3 class="text-center text-bold mt-2 ">DATA DANA DESA</h3>
            </div>
     ...
     <tbody>
        ...
        <tr>
            ...
            <td><strong>Total Pemasukan : {{  $dana_pemasukkan }}</strong></td>            
        </tr>
    </tbody>    
    </tbody>
    ...
    <tbody>
        ...
        <tfoot>    
            <tr>
                ...
                <td><strong>Total Pengeluaran: {{  $dana_pengeluaran }}</strong></td>            
            </tr>
            <tr>
