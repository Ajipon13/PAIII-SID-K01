...
<div class="container">
       ...
       <div class="card">
          <div class="catd-header">
               <h4 class="text-center mt-2">Tambah Tamu Baru!</h4>
               <hr>
          </div>
          @if ($errors->any())
            ...
            @endif
          <div class="container">
          <form action="{{ url('tamu.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
             <div class="row">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                         <input type="name" class="form-control form-control-lg" autofocus name="nik_tamu" id="nik_tamu" aria-describedby="nik_tamu" >
                     </div>
                    </div>
              ...
              <div class="form-group  row">
                  <label for="nama" class="col-sm-2 col-form-label text-sm">Nama</label>
                    <div class="col-sm-10">
                         <input type="name" class="form-control form-control-lg" id="nama_tamu" name="nama_tamu" aria-describedby="nama_tamu">
                  </div>
              </div>
              ...
              <div class="form-group  row">
                  <label for="nama" class="col-sm-2 col-form-label text-sm">Datang Dari</label>
                    <div class="col-sm-10">
                         <input type="name" class="form-control form-control-lg" id="asal" name="asal" aria-describedby="asal">
                  </div>
              </div>
               ...
               <div class="col">
                  ...
                  <div class="form-group row">
                        <div class="col-sm-10">            
                            <input type="date" class="form-control form-control-lg datepicker" id="tanggal_datang" name="tanggal_datang" aria-describedby="tanggal_datang" >
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">            
                            <input type="date" class="form-control form-control-lg datepicker" id="tanggal_balik" name="tanggal_balik" aria-describedby="tanggal_balik" >
                        </div>
                   ...
                   <div class="form-group row">
                       <div class="col-sm-10">
                          <input type="text" class="form-control form-control-lg" name="tujuan" id="tujuan" aria-describedby="tujuan" >
                        </div>
                   ...
                   <div class="form-group row">
                   <div class="col-sm-10">
                       <textarea type="text" class="form-control form-control-lg" id="ket" name="ket" aria-describedby="ket" ></textarea>
                    </div>
